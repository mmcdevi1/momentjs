...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Looper = function () {\n  function Looper() {\n    _classCallCheck(this, Looper);\n  }\n\n  _createClass(Looper, [{\n    key: \"run\",\n    value: function run(render, draw, engine, options) {\n      var canvas = render.canvas,\n          ctx = render.ctx,\n          physics = render.physics,\n          bodies = render.engine.world.bodies,\n          _render$options = render.options,\n          width = _render$options.width,\n          height = _render$options.height,\n          background = _render$options.background;\n\n\n      if (options.enable) {\n\n        setInterval(function () {\n          ctx.fillStyle = background;\n          ctx.fillRect(0, 0, canvas.width, canvas.height);\n\n          draw(render);\n          engine.update(engine, render);\n        }, 1000 / 60);\n      }\n      // requestAnimationFrame(this.run.bind(this))\n    }\n  }]);\n\n  return Looper;\n}();\n\nexports.default = Looper;\n\n//# sourceURL=webpack:///./src/Looper.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _RigidBody2 = __webpack_require__(/*! ./RigidBody */ \"./src/RigidBody.js\");\n\nvar _RigidBody3 = _interopRequireDefault(_RigidBody2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar RigidBodies = function (_RigidBody) {\n  _inherits(RigidBodies, _RigidBody);\n\n  function RigidBodies() {\n    _classCallCheck(this, RigidBodies);\n\n    return _possibleConstructorReturn(this, (RigidBodies.__proto__ || Object.getPrototypeOf(RigidBodies)).call(this));\n  }\n\n  _createClass(RigidBodies, [{\n    key: 'circle',\n    value: function circle(x, y, radius, options) {\n      var defaults = {\n        shape: 'circle',\n        radius: radius,\n        area: Math.round(Math.PI * Math.pow(radius, 2))\n      };\n\n      var extend = _extends({}, this.create(x, y), defaults, options);\n\n      return extend;\n    }\n  }, {\n    key: 'rect',\n    value: function rect(x, y, width, height, options) {\n      var defaults = {\n        shape: 'rect',\n        area: width * height,\n        width: width,\n        height: height\n      };\n\n      var extend = _extends({}, this.create(x, y), defaults, options);\n\n      return extend;\n    }\n  }]);\n\n  return RigidBodies;\n}(_RigidBody3.default);\n\nexports.default = RigidBodies;\n\n//# sourceURL=webpack:///./src/RigidBodies.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Sandbox = function () {\n  function Sandbox() {\n    _classCallCheck(this, Sandbox);\n  }\n\n  _createClass(Sandbox, [{\n    key: \"add\",\n    value: function add(world, rigidBodies) {\n      if (Array.isArray(rigidBodies)) {\n        var _iteratorNormalCompletion = true;\n        var _didIteratorError = false;\n        var _iteratorError = undefined;\n\n        try {\n\n          for (var _iterator = rigidBodies[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n            var body = _step.value;\n\n            console.log(body);\n            world.bodies.push(body);\n          }\n        } catch (err) {\n          _didIteratorError = true;\n          _iteratorError = err;\n        } finally {\n          try {\n            if (!_iteratorNormalCompletion && _iterator.return) {\n              _iterator.return();\n            }\n          } finally {\n            if (_didIteratorError) {\n              throw _iteratorError;\n            }\n          }\n        }\n      } else {\n        world.bodies.push(rigidBodies);\n      }\n    }\n  }]);\n\n  return Sandbox;\n}();\n\nexports.default = Sandbox;\n\n//# sourceURL=webpack:///./src/Sandbox.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Vector = function () {\n  function Vector(x, y) {\n    _classCallCheck(this, Vector);\n\n    this.x = x;\n    this.y = y;\n  }\n\n  _createClass(Vector, [{\n    key: \"add\",\n    value: function add(velocity) {\n      this.x += velocity.x;\n      this.y += velocity.y;\n    }\n  }, {\n    key: \"sub\",\n    value: function sub(velocity) {\n      this.x -= velocity.x;\n      this.y -= velocity.y;\n    }\n  }]);\n\n  return Vector;\n}();\n\nexports.default = Vector;\n\n//# sourceURL=webpack:///./src/Vector.js?");
...
"use strict";
eval("\n\nvar _Moment = __webpack_require__(/*! ./Moment */ \"./src/Moment.js\");\n\nvar _Moment2 = _interopRequireDefault(_Moment);\n\nvar _helpers = __webpack_require__(/*! ./helpers */ \"./src/helpers.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// Create new Moment JS Engine\nvar Engine = new _Moment2.default.Engine(),\n    Sandbox = new _Moment2.default.Sandbox(),\n    RigidBodies = new _Moment2.default.RigidBodies(),\n    Render = new _Moment2.default.Render(),\n    Physics = new _Moment2.default.Physics(),\n    Looper = new _Moment2.default.Looper(),\n    world = Engine.world;\n\n// Set physics to the Engine\nvar physics = Physics.create();\nEngine.set(physics);\n\n// Render canvas to the DOM\nvar render = Render.create({\n  element: document.body,\n  engine: Engine,\n  options: {\n    height: 800,\n    width: 800\n  }\n});\n\nvar bodies = [RigidBodies.rect(0, 700, 500, 100, { fillStyle: 'lightgrey', isStatic: true }), RigidBodies.rect((0, _helpers.floor)((0, _helpers.random)(500)), (0, _helpers.floor)((0, _helpers.random)(500)), 10, 50, { fillStyle: 'lightgrey', hasStroke: true })];\n\nfor (var i = 0; i < 1; i++) {\n  bodies.push(RigidBodies.circle((0, _helpers.floor)((0, _helpers.random)(800)), (0, _helpers.floor)((0, _helpers.random)(500)), (0, _helpers.floor)((0, _helpers.random)(25, 10)), { fillStyle: 'orange', hasStroke: true }));\n}\n\nSandbox.add(world, bodies);\n\nRender.draw(render);\n\nLooper.run(render, Render.draw, Engine, { enable: true });\n\n//# sourceURL=webpack:///./src/index.js?");
